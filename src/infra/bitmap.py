...
FONT_MEDIUM = {
    ...
    'T': (5, [0x1F, 0x04, 0x04, 0x04, 0x04, 0x04]),
    'U': (4, [0x09, 0x09, 0x09, 0x09, 0x09, 0x06]),
    'V': (5, [0x11, 0x11, 0x11, 0x0A, 0x0A, 0x04]),
    'W': (5, [0x11, 0x11, 0x15, 0x15, 0x0A, 0x0A]),
    'X': (4, [0x09, 0x09, 0x06, 0x06, 0x09, 0x09]),
    'Y': (5, [0x11, 0x0A, 0x04, 0x04, 0x04, 0x04]),
    'Z': (4, [0x0F, 0x01, 0x02, 0x04, 0x08, 0x0F]),
    # Digits
    '0': (4, [0x06, 0x09, 0x0B, 0x0D, 0x09, 0x06]),
    '1': (2, [0x02, 0x06, 0x02, 0x02, 0x02, 0x02]),
    ...
    'i': (1, [0x01, 0x00, 0x01, 0x01, 0x01, 0x01]),
    'j': (2, [0x01, 0x00, 0x01, 0x01, 0x05, 0x02]),
    'k': (3, [0x08, 0x09, 0x0A, 0x0C, 0x0A, 0x09]),
    'l': (1, [0x01, 0x01, 0x01, 0x01, 0x01, 0x01]),
    'm': (5, [0x00, 0x1A, 0x15, 0x15, 0x11, 0x11]),
    ...
    'w': (5, [0x00, 0x11, 0x15, 0x15, 0x0A, 0x0A]),
    ...
    '.': (1, [0x00, 0x00, 0x00, 0x00, 0x00, 0x01]),
    '-': (3, [0x00, 0x00, 0x07, 0x00, 0x00, 0x00]),
    ':': (1, [0x00, 0x01, 0x00, 0x00, 0x01, 0x00]),
}
...
def _render_line(rows: list[int], text: str, font_dict: dict, font_height: int, v_offset: int):
    ...
    col = LEFT_MARGIN
    char_spacing = 0  # No space between characters
